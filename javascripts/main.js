const pajamas = [
    {
      ...
      colors: "Brown - Yellow - Blue - White",
      size: "Sm - Md - Lg - Xl",
      category: "a",
      gender: "w",
      price: "$7.99"
...
pajamas.forEach(function(item) {
  ...
  info += `<article class="card">
            ...
            <section>
              <div class="card-img">
                <div class="image">
                  <img src="${item.img_ulr}" alt="Yellow Dunk">
                </div>
              </div>
            ...
            <section>
              <header class="specifications">
                ...
                <p class="item-detail-bold">Colors: </p><p class="item-detail"> ${item.colors}</p>
                <p class="item-detail-bold">Size: </p><p class="item-detail"> ${item.size}</p>
              </header>
              <footer class="specifications-footer">
              <hr class="card-hr">
                <p class="item-detail">
                  Specifications valid until 2018.
                </p>
              </footer>
            </section>
            <section>
              <header class="pricing">
                <p class="item-detail-bold">Price: </p><p class="item-detail"> ${item.price}</p>
              </header>
            </section>
          </article>`;
});
